    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-20">
          ...
          <nav class="hidden md:flex space-x-8 items-center">
            ...
            <a href="index.php" class="flex items-center text-gris1 font-semibold hover:text-vert-principale transition">
              <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"></path></svg>
              Accueil
            </a>

            <a href="src/pages/rechercher.php" class="flex items-center text-gris1 hover:text-vert-principale transition font-medium">
            ...
            <a href="src/pages/mes-trajets.php" class="flex items-center text-gris1 hover:text-vert-principale transition font-medium">
            ...
            <a href="src/pages/profil.php" class="flex items-center text-gris1 hover:text-vert-principale transition font-medium">
          ...
          <div class="flex items-center space-x-6">
            <a href="src/pages/proposer-trajet.php" class="bg-vert-principale text-white px-5 py-2 rounded-md font-medium hover:bg-vert-principal-h transition shadow-sm">
              Proposer un Trajet
            </a>

            <button class="text-gris1 hover:bg-rouge">
