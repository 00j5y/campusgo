<header x-data="{ isOpen: false }" class="bg-white shadow-lg relative z-50">
    <div class="mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-20">
            ...
            <nav class="hidden lg:flex space-x-8 items-center">
                ...
                <a href="{{ route('historique-trajet') }}" class="flex items-center text-gris1 hover:text-vert-principale transition font-medium">
                    <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                @auth
                    @if(Auth::user()->est_admin == 1)
                        <a href="{{ route('admin.utilisateurs') }}" class="flex items-center text-gris1 hover:text-vert-principale transition font-medium">
    ...
    <div x-show="isOpen"
        ...
        <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            ...
            <a href="{{ route('historique-trajet') }}" class="text-gris1 hover:text-vert-principale hover:bg-gray-50 px-3 py-2 rounded-md text-base font-medium flex items-center">
                <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"></path></svg>
                Mes Trajets
            </a>
            <a href="{{ route('profile.show') }}" class="text-gris1 hover:text-vert-principale hover:bg-gray-50 px-3 py-2 rounded-md text-base font-medium flex items-center">
