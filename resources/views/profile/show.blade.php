        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 lg:p-8">
            ...
            <div class="space-y-6">
                <div class="flex items-center justify-between p-4 rounded-xl border border-gray-100 hover:border-vert-principale/30 transition-colors bg-gray-50/50">
                    ...
                    <form action="{{ route('preference.toggle') }}" method="POST">@csrf @method('PATCH')<input type="hidden" name="field" value="accepte_animaux"><label class="relative inline-flex items-center cursor-pointer"><input type="checkbox" onchange="this.form.submit()" class="sr-only peer" {{ $user->preference?->accepte_animaux ? 'checked' : '' }}><div class="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-vert-principale/30 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-vert-principale"></div></label></form>
                </div>
                <div class="flex items-center justify-between p-4 rounded-xl border border-gray-100 hover:border-vert-principale/30 transition-colors bg-gray-50/50">
                    <div class="flex items-center gap-4">
                    ...
                    <form action="{{ route('preference.toggle') }}" method="POST">@csrf @method('PATCH')<input type="hidden" name="field" value="accepte_fumeurs"><label class="relative inline-flex items-center cursor-pointer"><input type="checkbox" onchange="this.form.submit()" class="sr-only peer" {{ $user->preference?->accepte_fumeurs ? 'checked' : '' }}><div class="w-11 h-6 bg-gray-200 peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-vert-principale"></div></label></form>
                </div>
                <div class="flex items-center justify-between p-4 rounded-xl border border-gray-100 hover:border-vert-principale/30 transition-colors bg-gray-50/50">
                    <div class="flex items-center gap-4">
                    ...
                    <form action="{{ route('preference.toggle') }}" method="POST">@csrf @method('PATCH')<input type="hidden" name="field" value="accepte_musique"><label class="relative inline-flex items-center cursor-pointer"><input type="checkbox" onchange="this.form.submit()" class="sr-only peer" {{ $user->preference?->accepte_musique ? 'checked' : '' }}><div class="w-11 h-6 bg-gray-200 peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-vert-principale"></div></label></form>
                </div>
                        </div>
                ...
                <form action="{{ route('preference.discussion') }}" method="POST" class="px-2">
                    ...
                    <div class="relative w-full">
                        ...
                        <input type="range" 
                            ...
                            style="accent-color: #68A35E;"> <div class="flex justify-between w-full px-1 mt-1">
                            @for ($i = 0; $i < 5; $i++)
