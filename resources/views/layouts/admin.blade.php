            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
                ...
                <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100 hover:shadow-md transition">
                    ...
                    <div class="flex items-center text-xs text-gray-400">
                        ...
                        <span>Total : {{ $stats['users'] ?? 0 }} utilisateurs</span>
                    </div>
                </div>

                <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100 hover:shadow-md transition">
                    <h3 class="text-gray-500 text-sm font-medium">Trajets en attente</h3>
                ...
                <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100 hover:shadow-md transition">
                    ...
                    <p class="text-3xl font-bold text-red-500 mt-2 mb-4">1</p> 
                    
                    <div class="flex items-center text-xs text-red-400 font-medium">
                        <svg class="w-4 h-4 mr-1.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
